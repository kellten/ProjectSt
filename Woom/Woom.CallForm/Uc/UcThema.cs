...
{
    public partial class UcThema : UserControl
    {
        public UcThema()
        {
            InitializeComponent();
        ...
        public string PropStockCode
        {
            ...
            set
            {
                ...
                ThemstStoreRecord("A", _stockCode);
            }
        }
        ...
        private void dgvThemaGroup_CellDoubleClick_1(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void dgvThema_CellDoubleClick_1(object sender, DataGridViewCellEventArgs e)
        {
            if (dgvThema.Rows[e.RowIndex].Cells["THEMA_CODE"].Value.ToString().Trim() != "")
            {
                ...
                object handler;
                handler = dgvThema_OnSelected;

                if (handler != null)
                {
                    dgvThema_OnSelected(dgvThema.Rows[e.RowIndex].Cells["THEMA_CODE"].Value.ToString().Trim());
                }
        ...
        private void btnThemaGroupStore_Click_1(object sender, EventArgs e)
        {
        ...
        private void btnClearThemaGroup_Click_1(object sender, EventArgs e)
        {
            txtThemaGroup.Text = "";
            lblThemaGroup.Text = "";
        }

        private void btnThemaStore_Click_1(object sender, EventArgs e)
        {
        ...
        private void btnThemaClear_Click_1(object sender, EventArgs e)
        {
            txtThema.Text = "";
            lblThema.Text = "";
        }

        private void BtnStoreThemaFromMemo_Click_1(object sender, EventArgs e)
        {
            if (txtThema.Text == "")
            {
