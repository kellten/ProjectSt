...
{
    public class ClsOpt10014 : IDisposable, IOptCaller
    {
        #region IOptCaller 구현
        private const string ConScreenNoFooter = "14";
        ...
        public event OnReceivedEventHandler Opt10014_OnReceived;
        ...
        private const string RqName = "공매도추이요청 ";
        private const string OptName = "opt10014";
        ...
        public void JustRequest(string StockCode, string StockName, int nPrevNext)
        {
            ...
            SendCommRqData(PlugIn.ClsAxKH.OptType.Opt10014, SetInputValue, RqName, OptName, nPrevNext, _screenNo);
        }
        ...
        private void AxKH_OnReceiveTrData(object sender, AxKHOpenAPILib._DKHOpenAPIEvents_OnReceiveTrDataEvent e)
        {
            ...
            var handler = Opt10014_OnReceived;
            ...
            if (nCnt == 0)
            {
                if (handler != null)
                {
                    Opt10014_OnReceived(_stockCode, null, 0);
                }
            }
            ...
            if (handler != null)
            {
                ...
                Opt10014_OnReceived(_stockCode, _dt, Convert.ToInt32(e.sPrevNext));
            }
        }
