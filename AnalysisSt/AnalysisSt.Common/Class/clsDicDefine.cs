...
namespace AnalysisSt.Common.Class
{
    public static class clsDicDefine
    {
        ...
        public const String IOFORE = "기외";
        public const String GIGAN_SUM = "기관합";

        public enum DicParamIndex { Gain = 0, Fore = 1, Gigan = 2, Gumy = 3, Bohum = 4 , Tosin = 5, 
        ...
        public static string GetVolumeJucheName(string value)
        {
            ...
            switch (value)
            {
             case "GAIN_PRICE":   return GAIN;                               case "GAIN_QTY":   return GAIN;
             case "FORE_PRICE":   return FORE;                               case "FORE_QTY":   return FORE; 
             case "GIGAN_PRICE":  return GIGAN;                              case "GIGAN_QTY":  return GIGAN;
             case "GUMY_PRICE":   return GUMY ;                              case "GUMY_QTY":   return GUMY ;
             case "BOHUM_PRICE":  return BOHUM;                              case "BOHUM_QTY":  return BOHUM;
             case "TOSIN_PRICE":  return TOSIN;                              case "TOSIN_QTY":  return TOSIN;
             case "GITA_PRICE":   return GITA;                               case "GITA_QTY":   return GITA;
             case "BANK_PRICE":   return BANK;                               case "BANK_QTY":   return BANK; 
             case "YEONGI_PRICE": return YEONGI;                             case "YEONGI_QTY": return YEONGI;
             case "SAMO_PRICE":   return SAMO;                               case "SAMO_QTY":   return SAMO;
             case "NATION_PRICE": return NATION;                             case "NATION_QTY": return NATION;
             case  "BUBIN_PRICE": return BUBIN;                              case  "BUBIN_QTY": return BUBIN;
             case "IOFORE_PRICE": return IOFORE;                             case "IOFORE_QTY": return IOFORE;
             case "GIGAN_SUM_PRICE": return GIGAN_SUM;                       case "GIGAN_SUM_QTY": return GIGAN_SUM;
        ...
        public static string GetVolumeData()
        {
            ...
            if (i > 1600)
            { stdDate = AnalysisSt.DataBaseFunc.CDateTime.FormatDate(System.DateTime.Now.Date.ToString()); }
            else
