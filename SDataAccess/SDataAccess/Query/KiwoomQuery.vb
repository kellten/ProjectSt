...
#Region "Constuctor"
    Sub New()
        InitClassVar(ClsServerInfo.VADISSEVER, "KIWOOMDB", "DEFAULT")
    End Sub

    Sub New(ByVal tableName As String)
        InitClassVar(ClsServerInfo.VADISSEVER, "KIWOOMDB", tableName)
    End Sub
    ...
    Sub New(ByVal tableName As String, ByVal cmdTimeOut As Integer)
        InitClassVar(ClsServerInfo.VADISSEVER, "KIWOOMDB", tableName, cmdTimeOut)
    End Sub
...
#Region "p_Opt10060PriceMinMaxQuery "
    Public Function p_Opt10060MinMaxQuery(ByVal query As String, ByVal stockCode As String, ByVal maemeGb As String,
                                               ByVal stockDate As String, ByVal bln3tier As Boolean,
                                      Optional ByVal ds As DataSet = Nothing, Optional ByVal tableName As String = Nothing) As DataSet
        ...
        If bln3tier = True Then
            Return ExecuteDataSet("p_Opt10060MinMaxQuery", CommandType.StoredProcedure, _tableName, _ds, _arrParam)
        Else
            Return ExecuteDataSet2Tier("p_Opt10060MinMaxQuery", CommandType.StoredProcedure, _tableName, _ds, _arrParam)
        End If
