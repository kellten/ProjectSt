...
namespace Chart
{
    public partial class frmChart : Form
    {
        ...
        private void InitChart()
        {
            ...
            this._baseChart.Series.Add(series13);
        ...
        private void DataCalcAll()
        {
            ...
            var parent = new Task(() =>
            {
                ...
                if (_baseChart.Series["캔들"].Points.Count >= 40)
                    new Task(() =>
                        this.DataCalc(FinancialFormula.MovingAverage, "40", "캔들:Y4", "40MA라인"), TaskCreationOptions.AttachedToParent
                    ).Start();
        ...
        private void SettingToolTip()
        {
            try
            {
                ...
                for (int ix = 0; ix < this._baseChart.Series["캔들"].Points.Count; ix++)
                {
                    ...
                    if (_baseChart.Series["40MA라인"].Points.Count >= 40)
                    {
                        line40 = _baseChart.Series["40MA라인"].Points[ix].YValues[0].ToString();
                    }
        ...
        private void chk3MA_CheckedChanged(object sender, EventArgs e)
        {
            switch (((CheckBox)sender).Name)
            {
                ...
                case "chk20MA":
                    ...
                    break;
                case "chk40MA":
                    this._baseChart.Series["40MA라인"].Enabled = ((CheckBox)sender).Checked;
                    break;
                case "chk60MA":
