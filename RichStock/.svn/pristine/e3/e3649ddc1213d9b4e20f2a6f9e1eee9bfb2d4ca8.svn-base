...
Public Class ucVolumeAnalysis
    ...
    Private Sub ucVolumeAnalysis_Disposed(sender As Object, e As EventArgs) Handles Me.Disposed
        _clsCombineCallOpt.FnRemoveHandler()
...
#Region " NowStatusVolume "
    ...
    Private Sub NowStatusVolume()
        ...
        For Each dr In _dtGiganSd.Rows
            Select Case dr("기간")
                Case "5일"
                    lblJudo5Day.Text = "5일 :" & dr(lblJudo.Text & "합")
                Case "10일"
                    lblJudo10Day.Text = "10일 :" & dr(lblJudo.Text & "합")
                Case "20일"
                    lblJudo20Day.Text = "20일 :" & dr(lblJudo.Text & "합")
                Case "60일"
                    lblJudo60Day.Text = "60일 :" & dr(lblJudo.Text & "합")
            End Select
        Next
