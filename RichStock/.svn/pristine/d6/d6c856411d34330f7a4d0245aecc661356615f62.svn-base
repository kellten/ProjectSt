...
#End Region
    ...
    Private Sub dgvFavStockList_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvFavStockList.CellDoubleClick
        If Trim(dgvFavStockList.Rows(e.RowIndex).Cells(DgvConditionStockListIndex.STOCK_CODE).Value) = "" Then Exit Sub

        _stockCode = Trim(dgvFavStockList.Rows(e.RowIndex).Cells(DgvConditionStockListIndex.STOCK_CODE).Value)
