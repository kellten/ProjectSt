    ...
    public partial class ucTradeAnalyChart : UserControl
    {
        ...
        private void DisplayChart(DataSet ds)
        {
            ...
            foreach (DataRowView dr in dv)
            {
                ...
                chartTradeAnaly.Series["개인"].Points.AddXY(dr["STOCK_DATE"], double.Parse(dr[AnSt.Define.clsDicDefine.GAIN_PRICE].ToString()));
                chartTradeAnaly.Series["외국인"].Points.AddXY(dr["STOCK_DATE"], double.Parse(dr[AnSt.Define.clsDicDefine.FORE_PRICE].ToString()));
                chartTradeAnaly.Series["기관"].Points.AddXY(dr["STOCK_DATE"], double.Parse(dr[AnSt.Define.clsDicDefine.GIGAN_PRICE].ToString()));
                chartTradeAnaly.Series["금융"].Points.AddXY(dr["STOCK_DATE"], double.Parse(dr[AnSt.Define.clsDicDefine.GUMY_PRICE].ToString()));
                chartTradeAnaly.Series["보험"].Points.AddXY(dr["STOCK_DATE"], double.Parse(dr[AnSt.Define.clsDicDefine.BOHUM_PRICE].ToString()));
                chartTradeAnaly.Series["투신"].Points.AddXY(dr["STOCK_DATE"], double.Parse(dr[AnSt.Define.clsDicDefine.TOSIN_PRICE].ToString()));
                chartTradeAnaly.Series["기타금융"].Points.AddXY(dr["STOCK_DATE"], double.Parse(dr[AnSt.Define.clsDicDefine.GITA_PRICE].ToString()));
                chartTradeAnaly.Series["은행"].Points.AddXY(dr["STOCK_DATE"], double.Parse(dr[AnSt.Define.clsDicDefine.BANK_PRICE].ToString()));
                chartTradeAnaly.Series["연기금"].Points.AddXY(dr["STOCK_DATE"], double.Parse(dr[AnSt.Define.clsDicDefine.YEONGI_PRICE].ToString()));
                chartTradeAnaly.Series["사모"].Points.AddXY(dr["STOCK_DATE"], double.Parse(dr[AnSt.Define.clsDicDefine.SAMO_PRICE].ToString()));
                chartTradeAnaly.Series["기법"].Points.AddXY(dr["STOCK_DATE"], double.Parse(dr[AnSt.Define.clsDicDefine.BUBIN_PRICE].ToString()));
                chartTradeAnaly.Series["기외"].Points.AddXY(dr["STOCK_DATE"], double.Parse(dr[AnSt.Define.clsDicDefine.IOFORE_PRICE].ToString()));
