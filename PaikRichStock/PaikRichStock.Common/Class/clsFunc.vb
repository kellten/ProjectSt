...
NextLoop:
    ...
    ' 반환: 없음
    '--------------------------------------------------------------------------------------
    Public Shared Sub EraseForm(ByVal container As Windows.Forms.Control, Optional ByVal blnNotEraseLock As Boolean = False)
...
#Region "FindControl"
    ...
    Private Shared _findControl As Windows.Forms.Control

    '------------------------------------------------------------------
    ' 재취호출을 통해서 폼 또는 사용자정의 컨트롤 내에 포함된 컨트롤 중
    '   검색하고자 하는 컨트롤의 성명과 동일한 컨트롤을 찾는다.
    '------------------------------------------------------------------
    Private Shared Sub FindControlRecursive(ByVal oControl As Windows.Forms.Control, ByVal findControlName As String)
    ...
    '---------------------------------------------------------------------------
    Public Shared Function FindControl(ByVal grpControl As GroupBox, ByVal findControlName As String) As Windows.Forms.Control
        Dim oControl As Windows.Forms.Control
    ...
    ' 사용자 정의 컨트롤 내의 여러 컨트롤 중 찾고자 하는 성명의 컨트를을 찾는다.
    '---------------------------------------------------------------------------
    Public Shared Function FindControl(ByVal pnlControl As Panel, ByVal findControlName As String) As Windows.Forms.Control
        Dim oControl As Windows.Forms.Control
    ...
    ' 사용자 정의 컨트롤 내의 여러 컨트롤 중 찾고자 하는 성명의 컨트를을 찾는다.
    '---------------------------------------------------------------------------
    Public Shared Function FindControl(ByVal ucForm As UserControl, ByVal findControlName As String) As Windows.Forms.Control
        Dim oControl As Windows.Forms.Control
    ...
    '---------------------------------------------------------------------------
    Public Shared Function FindControl(ByVal frmForm As Form, ByVal findControlName As String) As Windows.Forms.Control
        Dim oControl As Windows.Forms.Control
