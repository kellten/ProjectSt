Public Class clsKiwoomMarketInfoDefine
    ...
    Public Function KiwoomMaketInfoDefineDic(ByVal sKiwoomMaketInfoDefine As KiwoomMaketInfoDefineIndex, ByVal tableName As String, ByVal AxKH As AxKHOpenAPILib.AxKHOpenAPI, ByVal e As AxKHOpenAPILib._DKHOpenAPIEvents_OnReceiveTrDataEvent) As DataSet
