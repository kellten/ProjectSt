...
#Region " Load & Connect "
    ...
    Private Sub ucMainStockVer2_OnConnection(status As String) Handles UcMainStockVer2.OnEventConnect
        ...
        UcTotalVolumeAnaylsis1.MainStock = UcMainStockVer2
        ...
        With oDataGridView
            Select Case .Name
                Case dgvDart.Name
                    ...
                    UcStockVolumeAnalysis1.StockCode = Trim(.Rows(e.RowIndex).Cells(DgvRealDataDartIndex.STOCK_CODE).Value)
                Case dgvMyStock.Name
                    ...
                    'UcTotalVolumeAnaylsis1.StockCode = Trim(.Rows(e.RowIndex).Cells(DgvRealDataDartIndex.STOCK_CODE).Value)
                    UcStockVolumeAnalysis1.StockCode = Trim(.Rows(e.RowIndex).Cells(DgvRealDataIndex.STOCK_CODE).Value)
                Case dgvFav.Name
                    If Trim(.Rows(e.RowIndex).Cells(DgvRealDataIndex.STOCK_CODE).Value) = "" Then
                        Exit Sub
                    End If
...
#Region " UcMainStock Event "
    Private Sub ucMainStockVer2_OnReceiveTrCondition(ByVal ds As System.Data.DataSet) Handles UcMainStockVer2.OnReceiveTrCondition
...
#End Region
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        UcStockAvgMagipPrice1.PropWriteStockList = PaikRichStock.Common.clsFunc.FavAddDataGridViewToDataSet(dgvMyStock)
    End Sub
    ...
    Private Sub UcTotalVolumeAnaylsis1_Load(sender As Object, e As EventArgs) Handles UcTotalVolumeAnaylsis1.Load
