    ...
    Private Sub GetVolumeData()
        ...
        With dgvList
            For i As Integer = 0 To dgvList.Rows.Count - 1
                ...
                If strName.Contains("ETN") Or strName.Contains("선물") Or strName.Contains("트러스") Or strName.Contains("KBSTAR") Or strName.Contains("하이골드") Or strName.Contains("KINDEX") Or strName.Contains("KOSEF") Or strName.Contains("하나니켈") Or strName.Contains("TREX") Or strName.Contains("코리아0") Or strName.Contains("동북아") Or strName.Contains("아시아 ") Or strName.Contains("우B") Or strName.Contains("1호") Or strName.Contains("2호") Or strName.Contains("K") Or strName.Contains("채권") Or strName.Contains("신탁") Or strName.Contains("TIGER") Or strName.Contains("KODEX") Or strName.Contains("KINDEX") Or strName.Contains("ARIRANG") Or strName.Contains("합성") Or _
                   strName.Contains("KODEX") Or strName.Contains("TIGER") Or strName.Contains("KINDEX") Or strName.Contains("KBSTART") Or strName.Contains("ARIRANG") Then
                    .Rows(i).Cells(dgvIndex.JobGb).Value = "Y"
                    proBar.Value = proBar.Value + 1
                    Continue For
                End If
                ' 산술 오버플로우 유통금액량 이상
                If Trim(.Rows(i).Cells(dgvIndex.StockName).Value) = "유니더스" Then
                    .Rows(i).Cells(dgvIndex.JobGb).Value = "Y"
                    proBar.Value = proBar.Value + 1
                    Continue For
                End If
                ...
                ' 산술 오버플로우 유통금액량 이상
                If Trim(.Rows(i).Cells(dgvIndex.StockName).Value) = "호전실업" Then
                    .Rows(i).Cells(dgvIndex.JobGb).Value = "Y"
                    proBar.Value = proBar.Value + 1
                    Continue For
                End If

                If Mid(Trim(.Rows(i).Cells(dgvIndex.StockName).Value), 1, 1) = "5" Then
                    .Rows(i).Cells(dgvIndex.JobGb).Value = "Y"
                    proBar.Value = proBar.Value + 1
                    Continue For
                End If
