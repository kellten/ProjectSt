...
#Region "p_Psi01Query"
    ...
    Public Function p_Psi01Query(ByVal query As String, ByVal stockId As String, ByVal interId As Integer, ByVal interName As String, _
        ...
        returnDs = conn.GetDataTableSp("p_Psi02Query", arrParam)
        conn.Close()
        Return returnDs
    End Function
...
#Region "p_Psi01Add"
    ...
    Public Function p_Psi01Add(ByVal query As String, ByVal stockId As String, ByVal interId As Integer, ByVal interName As String, _
        ...
        conn.ExecuteNonQuery("p_Psi01Add", arrParam)
        conn.Close()
...
#Region "p_Psi02Add"
    ...
    Public Function p_Psi02Add(ByVal query As String, ByVal stockId As String, ByVal interId As Integer, ByVal stockCode As String, _
        ...
        conn.ExecuteNonQuery("p_Psi02Add", arrParam)
        conn.Close()
        Return True
    End Function
#End Region
...
#Region "p_psi02Del"
    ...
    Public Function p_psi02Del(ByVal query As String, ByVal stockId As String, ByVal interId As Integer, ByVal stockCode As String, _
        ...
        conn.ExecuteNonQuery("p_psi02Del", arrParam)
        conn.Close()
        Return True
    End Function
#End Region
...
#Region "p_D1a01Add"
    ...
    Public Function p_D1a01Add(ByVal query As String, ByVal deungDate As String, ByVal stockCode As String, _
        ...
        conn.ExecuteNonQuery("p_D1a01Add", arrParam)
        conn.Close()
        Return True
    End Function
#End Region
...
#Region "p_stock_day_data_Add"
    ...
    Public Function p_stock_day_data_Add(ByVal query As String, _
        ...
        Try
            conn.ExecuteNonQuery("p_stock_day_data_Add", arrParam)
            conn.Close()
            Return True
...
#Region "p_stock_week_data_Add"
    ...
    Public Function p_stock_week_data_Add(ByVal query As String, _
        ...
        Try
            conn.ExecuteNonQuery("p_stock_week_data_Add", arrParam)
            conn.Close()
            Return True
        Catch ex As Exception
            Return False
...
#Region "p_company_info_Add"
    ...
    Public Function p_company_info_Add(ByVal query As String, _
        ...
        conn.ExecuteNonQuery("p_company_info_Add", arrParam)
        conn.Close()
        Return True
...
#Region "p_company_info_query"
    ...
    Public Function p_company_info_query(ByVal query As String, ByVal stockCode As String, ByVal isConinueConnect As Boolean, _
        ...
        returnDs = conn.GetDataTableSp("p_company_info_query", arrParam)
        conn.Close()
        Return returnDs
...
#Region "p_stock_day_data_query"
    ...
    Public Function p_stock_day_data_query(ByVal query As String, ByVal stockCode As String, ByVal stockDate As String, ByVal isConinueConnect As Boolean, _
        ...
        Dim conn As New mySqlDbConn
        conn.Open()
        returnDs = conn.GetDataTableSp("p_stock_day_data_query", arrParam)
        conn.Close()
        Return returnDs
...
#Region "p_stock_week_data_query"
    ...
    Public Function p_stock_week_data_query(ByVal query As String, ByVal stockCode As String, ByVal stockDate As String, ByVal isConinueConnect As Boolean, _
        ...
        returnDs = conn.GetDataTableSp("p_stock_week_data_query", arrParam)
        conn.Close()
        Return returnDs
...
#Region "p_stock_day_data_query_MALowEnd"
    ...
    Public Function p_stock_day_data_query_MALowEnd(ByVal query As String, ByVal stockCode As String, ByVal stockDate As String, _
        ...
        returnDs = conn.GetDataTableSp("p_stock_day_data_query_MALowEnd", arrParam)
        conn.Close()
        Return returnDs
    End Function
#End Region
...
#Region "p_stock_day_data_query_Line"
    ...
    Public Function p_stock_day_data_query_Line(ByVal stockCode As String, ByVal line As String, _
        ...
        returnDs = conn.GetDataTableSp("p_stock_day_data_query_Line", arrParam)
        conn.Close()
        Return returnDs
    End Function
#End Region
...
#Region "p_Stock_Master_Add"
    ...
    Public Function p_Stock_Master_Add(ByVal query As String, ByVal stockCode As String, ByVal stockName As String, ByVal gubun As String, ByVal isConinueConnect As Boolean, _
        ...
        conn.ExecuteNonQuery("p_Stock_Master_Add", arrParam)
        conn.Close()
        Return True
    End Function
#End Region
...
#Region "p_company_ceo_Add"
    ...
    Public Function p_company_ceo_Add(ByVal query As String,
        ...
        conn.ExecuteNonQuery("p_company_ceo_Add", arrParam)
        conn.Close()
        Return True
    End Function
#End Region
...
#Region "p_stock_finance_Add"
    ...
    Public Function p_stock_finance_Add(ByVal query As String, _
        ...
        conn.ExecuteNonQuery("p_stock_finance_Add", arrParam)
        conn.Close()
        Return True
    End Function
#End Region
...
#Region "p_stock_batch_mibi"
    ...
    Public Function p_stock_batch_mibi(Optional ByVal ds As DataSet = Nothing, Optional ByVal tableName As String = Nothing) As DataSet
        ...
        returnDs = conn.GetDataTableSp("p_stock_batch_mibi", arrParam)
        conn.Close()
        Return returnDs
    End Function
#End Region
...
#Region "p_stock_day_data_query_Line2"
    ...
    Public Function p_stock_day_data_query_Line2(ByVal query As String, ByVal stockCode As String, ByVal isConinueConnect As Boolean, Optional ByVal ds As DataSet = Nothing, Optional ByVal tableName As String = Nothing) As DataSet
        ...
        returnDs = conn.GetDataTableSp("p_stock_day_data_query_Line2", arrParam)
        conn.Close()
        Return returnDs
    End Function
#End Region
...
#Region "p_stock_day_data_query_BB"
    ...
    Public Function p_stock_day_data_query_BB(ByVal stockCode As String, ByVal isConinueConnect As Boolean, Optional ByVal ds As DataSet = Nothing, Optional ByVal tableName As String = Nothing) As DataSet
        ...
        returnDs = conn.GetDataTableSp("p_stock_day_data_query_BB", arrParam)
        conn.Close()
        Return returnDs
    End Function
#End Region
...
#Region "p_stock_tick_Add"
    ...
    Public Function p_stock_tick_Add(ByVal query As String, _
        ...
        conn.ExecuteNonQuery("p_stock_tick_Add", arrParam)
        conn.Close()
        Return True
    End Function
#End Region
...
#Region "p_stock_tick_query"
    ...
    Public Function p_stock_tick_query(ByVal query As String, _
        ...
        returnDs = conn.GetDataTableSp("p_stock_tick_query", arrParam)
...
#Region "p_stock_finance_query"
    ...
    Public Function p_stock_finance_query(ByVal query As String, ByVal stockCode As String, ByVal isConinueConnect As Boolean, Optional ByVal ds As DataSet = Nothing, Optional ByVal tableName As String = Nothing) As DataSet
        ...
        returnDs = conn.GetDataTableSp("p_stock_finance_query", arrParam)
        conn.Close()
        Return returnDs
    End Function
#End Region

#Region "p_stock_theme_query"
    '--------------------------------------------------
    '테마데이터
    '--------------------------------------------------
    Public Function p_stock_theme_query(ByVal query As String, ByVal stockCode As String, ByVal themeName As String, ByVal isConinueConnect As Boolean, Optional ByVal ds As DataSet = Nothing, Optional ByVal tableName As String = Nothing) As DataSet
        ...
        With arrParam
            ...
            .Add("_QUERY", query)
            .Add("_STOCK_CODE", stockCode)
            .Add("_THEME_NAME", themeName)
        End With

        returnDs = conn.GetDataTableSp("p_stock_theme_query", arrParam)
        conn.Close()
        Return returnDs
    End Function
#End Region

#Region "p_stock_gong_query"
    '--------------------------------------------------
    '공매도동향
    '--------------------------------------------------
    Public Function p_stock_gong_query(ByVal query As String, ByVal stockCode As String, ByVal stockDate As String, ByVal isConinueConnect As Boolean, Optional ByVal ds As DataSet = Nothing, Optional ByVal tableName As String = Nothing) As DataSet
        ...
        Dim conn As New mySqlDbConn()
        returnDs = conn.GetDataTableSp("p_stock_gong_query", arrParam)
        conn.Close()
        Return returnDs
    End Function
#End Region

#Region "p_stock_credit_query"
    '--------------------------------------------------
    '신용매매동향
    '--------------------------------------------------
    Public Function p_stock_credit_query(ByVal query As String, ByVal stockCode As String, ByVal stockDate As String, ByVal isConinueConnect As Boolean, Optional ByVal ds As DataSet = Nothing, Optional ByVal tableName As String = Nothing) As DataSet
        ...
        Dim conn As New mySqlDbConn()
        returnDs = conn.GetDataTableSp("p_stock_credit_query", arrParam)
        conn.Close()
        Return returnDs
    End Function
#End Region

#Region "p_stock_buysell_state_query"
    '--------------------------------------------------
    '매매동향
    '--------------------------------------------------
    Public Function p_stock_buysell_state_query(ByVal query As String, ByVal stockCode As String, ByVal stockDate As String, ByVal isConinueConnect As Boolean, Optional ByVal ds As DataSet = Nothing, Optional ByVal tableName As String = Nothing) As DataSet
        ...
        Dim conn As New mySqlDbConn()
        returnDs = conn.GetDataTableSp("p_stock_buysell_state_query", arrParam)
        conn.Close()
        Return returnDs
    End Function
#End Region

#Region "p_stock_day_data_line_query"
    '--------------------------------------------------
    '일봉 LINE
    '--------------------------------------------------
    Public Function p_stock_day_data_line_query(ByVal query As String, ByVal stockCode As String, ByVal stockDate As String, ByVal isConinueConnect As Boolean, Optional ByVal ds As DataSet = Nothing, Optional ByVal tableName As String = Nothing) As DataSet
        ...
        Dim conn As New mySqlDbConn()
        returnDs = conn.GetDataTableSp("p_stock_day_data_line_query", arrParam)
        conn.Close()
        Return returnDs
...
#Region "p_stock_etc_query"
    '--------------------------------------------------
    '특이사항
    '--------------------------------------------------
    Public Function p_stock_etc_query(ByVal query As String, ByVal stockCode As String, ByVal stockDate As String, Optional ByVal ds As DataSet = Nothing, Optional ByVal tableName As String = Nothing) As DataSet
        ...
        returnDs = conn.GetDataTableSp("p_stock_etc_query", arrParam)
        conn.Close()
        Return returnDs
...
#Region "p_stock_profit_Add"
    '--------------------------------------------------
    '익절저장
    '--------------------------------------------------
    Public Function p_stock_profit_Add(ByVal query As String, _
                                            _ACCOUNT_NO As String, _
                                            _STOCK_CODE As String, _
                                            _SELL1_PRICE As String, _
                                            _SELL2_PRICE As String, _
                                            _SELL3_PRICE As String, _
                                            _SELL4_PRICE As String, _
                                            _SELL5_PRICE As String, _
                                            _GB As String) As Boolean
        ...
        With arrParam
            .Clear()
            .Add("_QUERY", query)
            .Add("_ACCOUNT_NO", _ACCOUNT_NO)
            .Add("_STOCK_CODE", _STOCK_CODE)
            .Add("_SELL1_PRICE", Val(_SELL1_PRICE))
            .Add("_SELL2_PRICE", Val(_SELL2_PRICE))
            .Add("_SELL3_PRICE", Val(_SELL3_PRICE))
            .Add("_SELL4_PRICE", Val(_SELL4_PRICE))
            .Add("_SELL5_PRICE", Val(_SELL5_PRICE))
            .Add("_GB", _GB)
        End With

        conn.ExecuteNonQuery("p_stock_profit_Add", arrParam)
        conn.Close()
        Return True
    End Function
#End Region
