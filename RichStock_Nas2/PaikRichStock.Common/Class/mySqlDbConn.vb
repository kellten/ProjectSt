...
Public Class mySqlDbConn
    Public _sqlCon As Odbc.OdbcConnection
    ...
    Public Function Open() As Boolean
        ...
        Try
            _sqlCon = New Odbc.OdbcConnection
            '_sqlCon.ConnectionString = "DSN=RichStock;USER=kojedevil;PASSWORD=rnjs99@;allow user variables=true;"
            _sqlCon.ConnectionString = "DRIVER={MySQL ODBC 5.3 ANSI Driver};SERVER=sundown99.ipdisk.co.kr;PORT=1433;DATABASE=kapi;USER=kojedevil;PASSWORD=rnjs99@;allow user variables=true;"
            _sqlCon.ConnectionTimeout = 30000
            _sqlCon.Open()
...
#Region " GetDataTableSp "
    ...
    Public Function GetDataTableSp(ByVal sp As String, ByVal arrParam As ArrayParam) As DataSet
        ...
        cmd = New Odbc.OdbcCommand(cmdText)
        cmd.Connection = _sqlCon
        cmd.CommandType = CommandType.StoredProcedure
