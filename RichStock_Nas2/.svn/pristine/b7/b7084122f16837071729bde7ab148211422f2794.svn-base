...
Public Structure StructParam
    ...
    Private _paramType As Odbc.OdbcType
...
Public Class ArrayParam
    ...
    Public Sub Add(ByVal paramName As String, ByVal value As Object, ByVal dbType As Odbc.OdbcType)
        Dim pSqlParam As New StructParam()
        pSqlParam.Name = paramName
        pSqlParam.Value = value
    ...
    'SQL저장시 이용
    'dbType : Stored Procedure의 데이터 type
    Public Sub Add(ByVal paramName As String, ByVal value As Object, ByVal dbType As Odbc.OdbcType, ByVal direct As ParameterDirection)
        Dim pSqlParam As New StructParam()
        pSqlParam.Name = paramName
        pSqlParam.Value = value
        pSqlParam.Type = dbType
    ...
    'SQL저장시 이용
    'dbType : Stored Procedure의 데이터 type
    Public Sub Add(ByVal paramName As String, ByVal value As Object, ByVal size As Integer, ByVal dbType As Odbc.OdbcType, ByVal direct As ParameterDirection)
        Dim pSqlParam As New StructParam()
        pSqlParam.Name = paramName
        pSqlParam.Value = value
        pSqlParam.Type = dbType
